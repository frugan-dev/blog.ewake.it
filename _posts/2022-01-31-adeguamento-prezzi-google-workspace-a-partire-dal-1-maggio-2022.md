...
A coloro invece che vorranno **mantenere l'attuale costo annuale dei servizi hosting/email**, offriremo la possibilità di migrare la posta sui server [EWake]({{ site.mainurl }}) **senza costi aggiuntivi**, anziché continuare ad utilizzare Google Workspace.  
